  ...
  for runtime_requirement in runtime_requirements.iter() {
    match runtime_requirement {
      ...
      RuntimeGlobals::DEFINE_PROPERTY_GETTERS => {
        ...
        runtime_modules_to_add.push((
          *chunk_ukey,
          DefinePropertyGettersRuntimeModule::new(&compilation.runtime_template, batch).boxed(),
        ));
      }
      RuntimeGlobals::GET_TRUSTED_TYPES_POLICY => {
        runtime_modules_to_add.push((
      ...
      RuntimeGlobals::CREATE_FAKE_NAMESPACE_OBJECT => {
        ...
        runtime_modules_to_add.push((
          *chunk_ukey,
          CreateFakeNamespaceObjectRuntimeModule::new(&compilation.runtime_template, batch).boxed(),
        ));
      }
      RuntimeGlobals::MAKE_NAMESPACE_OBJECT => {
        runtime_modules_to_add.push((
      ...
      RuntimeGlobals::COMPAT_GET_DEFAULT_EXPORT => {
        ...
        runtime_modules_to_add.push((
          *chunk_ukey,
          CompatGetDefaultExportRuntimeModule::new(&compilation.runtime_template, batch).boxed(),
        ));
      }
      RuntimeGlobals::ESM_MODULE_DECORATOR => {
        runtime_modules_to_add.push((
